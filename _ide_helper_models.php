 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Role search($keyword, $matchAllFields = false)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User filter(array $data, string $operator = 'AND')
